...
def _parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(description="Gemini YouTube Dubber hybrid cloud runner")
    p.add_argument("--youtube-url", required=True, help="Public YouTube URL")
...
def main() -> int:
    ...
    if not settings.api_key:
        raise SystemExit(
            "GEMINI_API_KEY is missing. Add it as a GitHub Actions repository secret."
        )
